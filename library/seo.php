...
function theme_ld_meta_tags() {
    ...
    $social_links = apply_filters('theme_social_links', array("t.me/genosinu","twitter.com","etherscan.io","Dextools.io"));
    ...
    $logo = theme_get_logo(array('default_src' => "/images/bd8a07a77e1a960c6970357de60fad1c.jpg", 'default_url' => ''));
    if (!empty($logo['src'])) {
